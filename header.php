...
<div class="site" id="page">
	...
	<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
		...
		<?php if (get_page_template_slug() === 'page-templates/max-page.php') : ?>
...
<div id="carouselExampleControls" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-title-container d-block">
    <div class="carousel-title"><?php echo get_bloginfo( 'name', 'display' ); ?></div>
  </div>
...
if (document.getElementById('carouselExampleControls')) {
	var slides = document.getElementById('carouselExampleControls').getElementsByClassName('carousel-item');
	if (slides.length > 0) {
